...
public class ShoesBag implements LogBase {
	
	public static void Shoes(WebDriver driver){
		
		By locator1=By.xpath("//div/p[text()='男鞋女鞋']/../div/a[1]/p");
		By Checklocator1=By.xpath("//a[text()='包包']");
		
		By locator2=By.xpath("//div/p[text()='男鞋女鞋']/../div/a[2]/p");
		By Checklocator2=By.xpath("//a[text()='男鞋']");
		
		By locator3=By.xpath("//div/p[text()='男鞋女鞋']/../div/a[3]/p");
		By Checklocator3=By.xpath("//a[text()='男鞋+女鞋']");
		
		By locator4=By.xpath("//div/p[text()='男鞋女鞋']/../div/a[4]/p");
		By Checklocator4=By.xpath("//a[text()='包包']");
		
		By locator5=By.xpath("//div/p[text()='男鞋女鞋']/../div/a[5]/p");
		By Checklocator5=By.xpath("//a[text()='女鞋']");
		
		By locator6=By.xpath("//div/p[text()='男鞋女鞋']/../div/a[6]/p");
		By Checklocator6=By.xpath("//a[text()='多个分类一起']");

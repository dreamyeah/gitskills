...
public class BuyPrdctByPriceSearch{
	...
	public void startChromePrintSceneMessage(){
		...
		System.out.println("+-----------------------------------------------------------------------+");
		System.out.println("|                          BuyPrdctByPriceSearch                        |");
		System.out.println("|                         测试场景：         通过价格搜索商品，并购买                                                             |");
		System.out.println("+-----------------------------------------------------------------------+");
	...
	@Test(priority = 5)
	public  void SearchPrdctByPriceTest() throws InterruptedException {

		Schedule.SearchPrdctByPrice(driver);    
	}

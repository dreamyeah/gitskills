...
public class BuyPrdctWithCouponAndPay {
	...
	public void startChromePrintSceneMessage(){
		...
		System.out.println("+-----------------------------------------------------------------------+");
		System.out.println("|                         BuyPrdctWithCouponAndPay                      |");
		System.out.println("|                     测试场景：          买一家商铺中的一件商品并用优惠券                                                        |");
		System.out.println("+-----------------------------------------------------------------------+");
	...
	@Test(priority = 8)
	public  void purchaseIndexTest() throws InterruptedException {
	...
	@Test(priority = 9)
	public  void SelectCouponTest() throws InterruptedException {

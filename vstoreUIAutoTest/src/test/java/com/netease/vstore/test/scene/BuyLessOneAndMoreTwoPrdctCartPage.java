 ...
 *
 */
public class BuyLessOneAndMoreTwoPrdctCartPage {
	@BeforeSuite
	...
	public void startChromePrintSceneMessage(){
		...
		System.out.println("+-----------------------------------------------------------------------+");
		System.out.println("|                    BuyLessOneAndMoreTwoPrdctCartPage                  |");
		System.out.println("|                 测试场景：       在CartPage购买同一商品 少于一件和多于两件                                              |");
		System.out.println("+-----------------------------------------------------------------------+");
	}
	...
	public void buyLessThanOneTest(){
		//num此时购买商品数量
		int num=1;
		changePrdtCount.decrPrdtCountCartPage(driver,num);
	...
	public void buyMoreThanTwoTest(){
		...
		changePrdtCount.incrPrdtCountCartPage(driver,num+1);

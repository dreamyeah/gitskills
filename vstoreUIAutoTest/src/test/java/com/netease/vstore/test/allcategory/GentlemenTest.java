...
import com.netease.vstore.Category.Gentlemen;
...
public class GentlemenTest {
	...
	public void startChromePrintSceneMessage(){
		...
		System.out.println("+-----------------------------------------------------------------------+");
		System.out.println("|                            GentlemenTest                              |");
		System.out.println("|                        测试场景：      所有分类中男装的商品                                                                           |");
		System.out.println("+-----------------------------------------------------------------------+");
	}
	...
	@Test(priority = 5)
	public void MenTopClothesTest(){
		
		Gentlemen.MenTopClothes(driver);
		
	}
	
	@Test(priority = 6)
	public void MenTrousers(){
		
		Gentlemen.MenTrousers(driver);

...
import com.netease.vstore.Category.Cosmetic;
...
public class CosmeticTest {
	...
	public void startChromePrintSceneMessage(){
		...
		System.out.println("+-----------------------------------------------------------------------+");
		System.out.println("|                            CosmeticTest                               |");

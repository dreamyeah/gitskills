...
import com.netease.vstore.Category.ShoesBag;
...
public class ShoesBagTest {
	...
	public void startChromePrintSceneMessage(){
		...
		System.out.println("+-----------------------------------------------------------------------+");
		System.out.println("|                           ShoesBagTest                                |");
		System.out.println("|                      测试场景：       所有分类中鞋包的商品                                                                                |");
		System.out.println("+-----------------------------------------------------------------------+");
	}

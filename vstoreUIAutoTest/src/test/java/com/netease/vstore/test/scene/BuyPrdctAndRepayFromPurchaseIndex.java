 ...
 * 
 */
public class BuyPrdctAndRepayFromPurchaseIndex {
	...
	public void startChromePrintSceneMessage(){
		...
		System.out.println("+-----------------------------------------------------------------------+");
		System.out.println("|                    BuyPrdctAndRepayFromPurchaseIndex                  |");
		System.out.println("|               测试场景：  购买商品首次支付失败，从PurchaseIndex页面重新支付                                   |");
		System.out.println("+-----------------------------------------------------------------------+");
	}

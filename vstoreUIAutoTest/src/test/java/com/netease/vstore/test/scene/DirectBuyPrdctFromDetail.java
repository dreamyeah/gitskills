...
public class DirectBuyPrdctFromDetail
{
	@BeforeSuite
	...
	public void startChromePrintSceneMessage(){
		...
		System.out.println("+-----------------------------------------------------------------------+");
		System.out.println("|                         DirectBuyPrdctFromDetail                      |");
		System.out.println("|                       测试场景：         在detail页面直接购买商品                                                             |");
		System.out.println("+-----------------------------------------------------------------------+");
	}
	...
	@Test(priority = 6)
	public  void purchaseFromDetailTest() throws InterruptedException {
				
		Purchase.purchaseFromDetail(driver);

...
public class BuyPrdctWithSelectColorAndSize
{
	...
	public void startChromePrintSceneMessage(){
		...
		System.out.println("+-----------------------------------------------------------------------+");
		System.out.println("|                       BuyPrdctWithSelectColorAndSize                  |");
		System.out.println("|                         测试场景：        选择颜色和尺码并购买商品                                                              |");
		System.out.println("+-----------------------------------------------------------------------+");
	...
	public  void SelectColorTest() throws InterruptedException {
		...
		Detail.SelectColor(driver);
		
	}
	
	@Test(priority = 7)
	public  void SelectSizeTest() throws InterruptedException {
			
		Detail.SelectSize(driver);

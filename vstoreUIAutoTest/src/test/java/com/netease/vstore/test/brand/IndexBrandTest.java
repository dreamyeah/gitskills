...
public class IndexBrandTest {
	...
	public void startChromePrintSceneMessage(){
		...
		System.out.println("+-----------------------------------------------------------------------+");
		System.out.println("|                            IndexBrandTest                             |");
		System.out.println("|                          测试场景：      主页中的品牌                                                                                     |");
		System.out.println("+-----------------------------------------------------------------------+");
	}
	...
	@Test(priority = 3)
	public  void checkIndexBrandTest() throws InterruptedException {
	
		
		Brand.checkIndexBrand(driver);    
	}
